...
(cl:defmethod cl:initialize-instance :after ((m <action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigator-msg:<action> is deprecated: use navigator-msg:action instead.")))
...
(cl:defmethod onlineflag-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navigator-msg:onlineflag-val is deprecated.  Use navigator-msg:onlineflag instead.")
  (onlineflag m))
