...
(cl:defmethod cl:initialize-instance :after ((m <position_pub>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position_pub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clik-msg:<position_pub> is deprecated: use clik-msg:position_pub instead.")))

(cl:ensure-generic-function 'time_stamp-val :lambda-list '(m))
(cl:defmethod time_stamp-val ((m <position_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-msg:time_stamp-val is deprecated.  Use clik-msg:time_stamp instead.")
  (time_stamp m))

(cl:ensure-generic-function 'X-val :lambda-list '(m))
(cl:defmethod X-val ((m <position_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-msg:X-val is deprecated.  Use clik-msg:X instead.")
  (X m))

(cl:ensure-generic-function 'Y-val :lambda-list '(m))
(cl:defmethod Y-val ((m <position_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-msg:Y-val is deprecated.  Use clik-msg:Y instead.")
  (Y m))

(cl:ensure-generic-function 'Z-val :lambda-list '(m))
(cl:defmethod Z-val ((m <position_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-msg:Z-val is deprecated.  Use clik-msg:Z instead.")
  (Z m))
