...
(cl:defmethod cl:initialize-instance :after ((m <manipulator_mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'manipulator_mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clik-srv:<manipulator_mode-request> is deprecated: use clik-srv:manipulator_mode-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <manipulator_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:mode-val is deprecated.  Use clik-srv:mode instead.")
  (mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <manipulator_mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'manipulator_mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clik-srv:<manipulator_mode-response> is deprecated: use clik-srv:manipulator_mode-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <manipulator_mode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:result-val is deprecated.  Use clik-srv:result instead.")
  (result m))
