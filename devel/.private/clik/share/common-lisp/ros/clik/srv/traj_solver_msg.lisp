...
(cl:defmethod cl:initialize-instance :after ((m <traj_solver_msg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traj_solver_msg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clik-srv:<traj_solver_msg-request> is deprecated: use clik-srv:traj_solver_msg-request instead.")))

(cl:ensure-generic-function 's_scale-val :lambda-list '(m))
(cl:defmethod s_scale-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:s_scale-val is deprecated.  Use clik-srv:s_scale instead.")
  (s_scale m))

(cl:ensure-generic-function 'x_upperPosition-val :lambda-list '(m))
(cl:defmethod x_upperPosition-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_upperPosition-val is deprecated.  Use clik-srv:x_upperPosition instead.")
  (x_upperPosition m))

(cl:ensure-generic-function 'x_lowerPosition-val :lambda-list '(m))
(cl:defmethod x_lowerPosition-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_lowerPosition-val is deprecated.  Use clik-srv:x_lowerPosition instead.")
  (x_lowerPosition m))

(cl:ensure-generic-function 'x_upperVelocity-val :lambda-list '(m))
(cl:defmethod x_upperVelocity-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_upperVelocity-val is deprecated.  Use clik-srv:x_upperVelocity instead.")
  (x_upperVelocity m))

(cl:ensure-generic-function 'x_lowerVelocity-val :lambda-list '(m))
(cl:defmethod x_lowerVelocity-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_lowerVelocity-val is deprecated.  Use clik-srv:x_lowerVelocity instead.")
  (x_lowerVelocity m))

(cl:ensure-generic-function 'x_upperAccelera-val :lambda-list '(m))
(cl:defmethod x_upperAccelera-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_upperAccelera-val is deprecated.  Use clik-srv:x_upperAccelera instead.")
  (x_upperAccelera m))

(cl:ensure-generic-function 'x_lowerAccelera-val :lambda-list '(m))
(cl:defmethod x_lowerAccelera-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_lowerAccelera-val is deprecated.  Use clik-srv:x_lowerAccelera instead.")
  (x_lowerAccelera m))

(cl:ensure-generic-function 'x_0-val :lambda-list '(m))
(cl:defmethod x_0-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_0-val is deprecated.  Use clik-srv:x_0 instead.")
  (x_0 m))

(cl:ensure-generic-function 'x_n-val :lambda-list '(m))
(cl:defmethod x_n-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_n-val is deprecated.  Use clik-srv:x_n instead.")
  (x_n m))

(cl:ensure-generic-function 'x_v0-val :lambda-list '(m))
(cl:defmethod x_v0-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_v0-val is deprecated.  Use clik-srv:x_v0 instead.")
  (x_v0 m))

(cl:ensure-generic-function 'x_vn-val :lambda-list '(m))
(cl:defmethod x_vn-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:x_vn-val is deprecated.  Use clik-srv:x_vn instead.")
  (x_vn m))

(cl:ensure-generic-function 'y_upperPosition-val :lambda-list '(m))
(cl:defmethod y_upperPosition-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_upperPosition-val is deprecated.  Use clik-srv:y_upperPosition instead.")
  (y_upperPosition m))

(cl:ensure-generic-function 'y_lowerPosition-val :lambda-list '(m))
(cl:defmethod y_lowerPosition-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_lowerPosition-val is deprecated.  Use clik-srv:y_lowerPosition instead.")
  (y_lowerPosition m))

(cl:ensure-generic-function 'y_upperVelocity-val :lambda-list '(m))
(cl:defmethod y_upperVelocity-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_upperVelocity-val is deprecated.  Use clik-srv:y_upperVelocity instead.")
  (y_upperVelocity m))

(cl:ensure-generic-function 'y_lowerVelocity-val :lambda-list '(m))
(cl:defmethod y_lowerVelocity-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_lowerVelocity-val is deprecated.  Use clik-srv:y_lowerVelocity instead.")
  (y_lowerVelocity m))

(cl:ensure-generic-function 'y_upperAccelera-val :lambda-list '(m))
(cl:defmethod y_upperAccelera-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_upperAccelera-val is deprecated.  Use clik-srv:y_upperAccelera instead.")
  (y_upperAccelera m))

(cl:ensure-generic-function 'y_lowerAccelera-val :lambda-list '(m))
(cl:defmethod y_lowerAccelera-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_lowerAccelera-val is deprecated.  Use clik-srv:y_lowerAccelera instead.")
  (y_lowerAccelera m))

(cl:ensure-generic-function 'y_0-val :lambda-list '(m))
(cl:defmethod y_0-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_0-val is deprecated.  Use clik-srv:y_0 instead.")
  (y_0 m))

(cl:ensure-generic-function 'y_n-val :lambda-list '(m))
(cl:defmethod y_n-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_n-val is deprecated.  Use clik-srv:y_n instead.")
  (y_n m))

(cl:ensure-generic-function 'y_v0-val :lambda-list '(m))
(cl:defmethod y_v0-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_v0-val is deprecated.  Use clik-srv:y_v0 instead.")
  (y_v0 m))

(cl:ensure-generic-function 'y_vn-val :lambda-list '(m))
(cl:defmethod y_vn-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:y_vn-val is deprecated.  Use clik-srv:y_vn instead.")
  (y_vn m))

(cl:ensure-generic-function 'z_upperPosition-val :lambda-list '(m))
(cl:defmethod z_upperPosition-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_upperPosition-val is deprecated.  Use clik-srv:z_upperPosition instead.")
  (z_upperPosition m))

(cl:ensure-generic-function 'z_lowerPosition-val :lambda-list '(m))
(cl:defmethod z_lowerPosition-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_lowerPosition-val is deprecated.  Use clik-srv:z_lowerPosition instead.")
  (z_lowerPosition m))

(cl:ensure-generic-function 'z_upperVelocity-val :lambda-list '(m))
(cl:defmethod z_upperVelocity-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_upperVelocity-val is deprecated.  Use clik-srv:z_upperVelocity instead.")
  (z_upperVelocity m))

(cl:ensure-generic-function 'z_lowerVelocity-val :lambda-list '(m))
(cl:defmethod z_lowerVelocity-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_lowerVelocity-val is deprecated.  Use clik-srv:z_lowerVelocity instead.")
  (z_lowerVelocity m))

(cl:ensure-generic-function 'z_upperAccelera-val :lambda-list '(m))
(cl:defmethod z_upperAccelera-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_upperAccelera-val is deprecated.  Use clik-srv:z_upperAccelera instead.")
  (z_upperAccelera m))

(cl:ensure-generic-function 'z_lowerAccelera-val :lambda-list '(m))
(cl:defmethod z_lowerAccelera-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_lowerAccelera-val is deprecated.  Use clik-srv:z_lowerAccelera instead.")
  (z_lowerAccelera m))

(cl:ensure-generic-function 'z_0-val :lambda-list '(m))
(cl:defmethod z_0-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_0-val is deprecated.  Use clik-srv:z_0 instead.")
  (z_0 m))

(cl:ensure-generic-function 'z_n-val :lambda-list '(m))
(cl:defmethod z_n-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_n-val is deprecated.  Use clik-srv:z_n instead.")
  (z_n m))

(cl:ensure-generic-function 'z_v0-val :lambda-list '(m))
(cl:defmethod z_v0-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_v0-val is deprecated.  Use clik-srv:z_v0 instead.")
  (z_v0 m))

(cl:ensure-generic-function 'z_vn-val :lambda-list '(m))
(cl:defmethod z_vn-val ((m <traj_solver_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:z_vn-val is deprecated.  Use clik-srv:z_vn instead.")
  (z_vn m))
...
(cl:defmethod cl:initialize-instance :after ((m <traj_solver_msg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traj_solver_msg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clik-srv:<traj_solver_msg-response> is deprecated: use clik-srv:traj_solver_msg-response instead.")))

(cl:ensure-generic-function 'resultstatus-val :lambda-list '(m))
(cl:defmethod resultstatus-val ((m <traj_solver_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clik-srv:resultstatus-val is deprecated.  Use clik-srv:resultstatus instead.")
  (resultstatus m))
