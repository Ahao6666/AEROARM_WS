...
(cl:defmethod cl:initialize-instance :after ((m <action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name calibration-msg:<action> is deprecated: use calibration-msg:action instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:header-val is deprecated.  Use calibration-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'uav_id-val :lambda-list '(m))
(cl:defmethod uav_id-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:uav_id-val is deprecated.  Use calibration-msg:uav_id instead.")
  (uav_id m))

(cl:ensure-generic-function 'behavior-val :lambda-list '(m))
(cl:defmethod behavior-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:behavior-val is deprecated.  Use calibration-msg:behavior instead.")
  (behavior m))

(cl:ensure-generic-function 'behaviormode-val :lambda-list '(m))
(cl:defmethod behaviormode-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:behaviormode-val is deprecated.  Use calibration-msg:behaviormode instead.")
  (behaviormode m))

(cl:ensure-generic-function 'onlineflag-val :lambda-list '(m))
(cl:defmethod onlineflag-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:onlineflag-val is deprecated.  Use calibration-msg:onlineflag instead.")
  (onlineflag m))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:params-val is deprecated.  Use calibration-msg:params instead.")
  (params m))
