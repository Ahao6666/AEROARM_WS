...
(cl:defmethod cl:initialize-instance :after ((m <position_pub>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position_pub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name calibration-msg:<position_pub> is deprecated: use calibration-msg:position_pub instead.")))

(cl:ensure-generic-function 'time_stamp-val :lambda-list '(m))
(cl:defmethod time_stamp-val ((m <position_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:time_stamp-val is deprecated.  Use calibration-msg:time_stamp instead.")
  (time_stamp m))
...
(cl:defmethod Z-val ((m <position_pub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration-msg:Z-val is deprecated.  Use calibration-msg:Z instead.")
  (Z m))
