...
(cl:defmethod cl:initialize-instance :after ((m <traj_out_msg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traj_out_msg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task_plan-srv:<traj_out_msg-request> is deprecated: use task_plan-srv:traj_out_msg-request instead.")))

(cl:ensure-generic-function 'times-val :lambda-list '(m))
(cl:defmethod times-val ((m <traj_out_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:times-val is deprecated.  Use task_plan-srv:times instead.")
  (times m))
...
(cl:defmethod cl:initialize-instance :after ((m <traj_out_msg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traj_out_msg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task_plan-srv:<traj_out_msg-response> is deprecated: use task_plan-srv:traj_out_msg-response instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:x-val is deprecated.  Use task_plan-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'dx-val :lambda-list '(m))
(cl:defmethod dx-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:dx-val is deprecated.  Use task_plan-srv:dx instead.")
  (dx m))

(cl:ensure-generic-function 'ddx-val :lambda-list '(m))
(cl:defmethod ddx-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:ddx-val is deprecated.  Use task_plan-srv:ddx instead.")
  (ddx m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:y-val is deprecated.  Use task_plan-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'dy-val :lambda-list '(m))
(cl:defmethod dy-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:dy-val is deprecated.  Use task_plan-srv:dy instead.")
  (dy m))

(cl:ensure-generic-function 'ddy-val :lambda-list '(m))
(cl:defmethod ddy-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:ddy-val is deprecated.  Use task_plan-srv:ddy instead.")
  (ddy m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:z-val is deprecated.  Use task_plan-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'dz-val :lambda-list '(m))
(cl:defmethod dz-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:dz-val is deprecated.  Use task_plan-srv:dz instead.")
  (dz m))

(cl:ensure-generic-function 'ddz-val :lambda-list '(m))
(cl:defmethod ddz-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:ddz-val is deprecated.  Use task_plan-srv:ddz instead.")
  (ddz m))

(cl:ensure-generic-function 'flag_begin-val :lambda-list '(m))
(cl:defmethod flag_begin-val ((m <traj_out_msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task_plan-srv:flag_begin-val is deprecated.  Use task_plan-srv:flag_begin instead.")
  (flag_begin m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<traj_out_msg-response>)))
  ...
  "task_plan/traj_out_msgResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'traj_out_msg-response)))
  "Returns string type for a service object of type 'traj_out_msg-response"
  "task_plan/traj_out_msgResponse")
