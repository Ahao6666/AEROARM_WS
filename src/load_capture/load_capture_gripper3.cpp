...
int main(int argc, char **argv)
{
    ...
    ROS_INFO("load_capture_gripper_3 init!");

    // 创建节点句柄
    ros::NodeHandle n;

    // 创建一个Publisher，发布名为/joint/gripper1/position_cmd的topic，消息类型为std_msgs::Float32，队列长度10
    ros::Publisher gripper1_pub = n.advertise<std_msgs::Float32>("/joint/gripper3_1/position_cmd", 10);
    ros::Publisher gripper2_pub = n.advertise<std_msgs::Float32>("/joint/gripper3_2/position_cmd", 10);
